...
let RCTParentScrollView;
let RCTScrollContentView;

if (Platform.OS === 'android') {
  AndroidScrollView = requireNativeComponent('RCTParentScrollView');
  AndroidHorizontalScrollView = requireNativeComponent(
    'AndroidHorizontalParentScrollView',
  );
  AndroidHorizontalScrollContentView = requireNativeComponent(
    'AndroidHorizontalParentScrollContentView',
  );
} else if (Platform.OS === 'ios') {
  RCTParentScrollView = requireNativeComponent('RCTParentScrollView');
