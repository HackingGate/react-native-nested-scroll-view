 ...
 */
 ...
 import type {EdgeInsetsProp} from 'react-native/StyleSheet/EdgeInsetsPropType';
 import type {PointProp} from 'react-native/StyleSheet/PointPropType';
 import type {ViewStyleProp} from 'react-native/StyleSheet/StyleSheet';
 import type {ColorValue} from 'react-native/StyleSheet/StyleSheetTypes';
 import type {
   PressEvent,
   ScrollEvent,
   LayoutEvent,
 } from 'react-native/Types/CoreEventTypes';
 import type {HostComponent} from 'react-native/Renderer/shims/ReactNativeTypes';
 import type {State as ScrollResponderState} from 'react-native/Libraries/ScrollResponder';
 import type {ViewProps} from 'react-native/Libraries/View/ViewPropTypes';
 import type {Props as ScrollViewStickyHeaderProps} from 'react-native/Libraries/Components/ScrollViewStickyHeader';
